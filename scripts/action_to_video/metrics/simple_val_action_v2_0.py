...
def load_models(pretrained_model_name_or_path = '/mnt/lustrenew/wangxiaodong/smodels-vis/video-v01-v-ep100-s192-5e-5', device='cuda:0'):
    ...
    scheduler = DDPMScheduler.from_pretrained('/mnt/lustrenew/wangxiaodong/smodels/image-ep50-s192-1e-4', subfolder="scheduler")
...
def main(
    pretrained_model_name_or_path = '/mnt/lustrenew/wangxiaodong/smodels-vis/action-v20--5e-5/checkpoint-5000',
    num_frames = 8,
