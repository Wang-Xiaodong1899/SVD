...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default="/mnt/lustrenew/wangxiaodong/models/stable-diffusion-2-1",
        required=True,
...
def main():
    ...
    with accelerator.main_process_first():
        train_dataset = keyframes(split='train', args=args, tokenizer=tokenizer, img_size=(384, 768))
