...
from diffusers.pipelines.stable_video_diffusion.pipeline_action_video_diffusion_v1_v_imclip_debug import ActionVideoDiffusionPipeline
# fix fps=3
...
def load_models(pretrained_model_name_or_path = '/mnt/lustrenew/wangxiaodong/smodels-vis/video-v01-v-ep100-s192-5e-5', device='cuda:0'):
    ...
    unet = UNetSpatioTemporalConditionModel_Action(cross_attention_dim=768, in_channels=4, temp_style = "text-image")
    tensors = {}
...
def main(
    ...
    version = os.path.basename(pretrained_model_name_or_path) + "-debug"
