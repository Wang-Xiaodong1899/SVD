...
git_processor_large = AutoProcessor.from_pretrained("/home/wxd/git-large-coco")
git_model_large = AutoModelForCausalLM.from_pretrained("/home/wxd/git-large-coco")
...
def main(
    ...
    # save for a json 
    with open(f'/ssd_datasets/wxiaodong/nuscene/nuscene_caption_{split}.json', 'w') as f:
