...
def main(
    tgt_dir='/mnt/storage/user/wangxiaodong/DWM_work_dir/lidar_maskgit_debug/FVD-first-8-action/wm_action2video_freeze_ac_bs64-checkpoint-10000-1.0-3-step25',
    version = None,
    num_frames=8,
    eval_frames=36,
    batch_size=16, 
    ...
    # read real video
    meta_data = json2data('/mnt/storage/user/wangxiaodong/nuscenes/samples_group_val.json')
