...
def main(
        ...
        tgt_dir='/mnt/storage/user/wangxiaodong/DWM_work_dir/lidar_maskgit_debug/FVD-first-8-action/checkpoint-15000--1.0-1.0-step25',
        version = None,
        split='val',
        num_frames=8,
        i3d_device='cuda:0',
        ...
        for file in files:
            if file.split('.')[-1] == 'mp4':
                ...
                for idx in choosed_idxs:
                    syn_videos.append(video_arr[idx: idx+eval_frames])
