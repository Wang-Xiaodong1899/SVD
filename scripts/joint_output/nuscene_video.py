...
class Actionframes(Dataset):
    def __init__(self, args, tokenizer: PreTrainedTokenizer, split='train', max_video_len = 8, img_size=(192,384)):
        super().__init__()
    ...
    def __getitem__(self, index):
        try:
            ...
            seek_start = random.randint(0, mini_len - self.max_video_len)
            ...
            # transfer
            seek_steer = torch.tensor(seek_angle) * 10 + 90 # default
