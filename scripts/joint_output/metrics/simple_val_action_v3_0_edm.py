...
from diffusers.pipelines.stable_video_diffusion.pipeline_action_video_norm_edm import ActionVideoDiffusionPipeline

from scripts.joint_output.nuscene_video_val import Actionframes
...
def load_models(pretrained_model_name_or_path = '/-vis/action-v30--5e-5/checkpoint-6000', device='cuda:0'):
    ...
    scheduler = EulerDiscreteScheduler.from_pretrained('/mnt/afs/user/wangxiaodong/driving-world-models/SDM/smodels/stable-video-diffusion-img2vid', subfolder="scheduler")
...
def main(
    pretrained_model_name_or_path = '/mnt/afs/user/wangxiaodong/driving-world-models/SDM/smodels-vis/action_v3_edm-5e-5/checkpoint-1500',
    num_frames = 8,
