...
sys.path.append('/mnt/afs/user/wangxiaodong/driving-world-models/SDM')
...
from diffusers.models.unet_action_joint_attn import UNetSpatioTemporalConditionModel_Action
from diffusers import AutoencoderKL, DDPMScheduler, StableDiffusionPipeline, UNet2DConditionModel, DDIMScheduler
from diffusers.pipelines.stable_video_diffusion.pipeline_action_joint_norm import ActionVideoDiffusionPipeline
...
def load_models(pretrained_model_name_or_path = '/-vis/action-v30--5e-5/checkpoint-6000', device='cuda:0'):
    text_encoder = CLIPTextModel.from_pretrained(
                '/mnt/afs/user/wangxiaodong/driving-world-models/SDM/smodels/image-ep50-s192-1e-4', subfolder="text_encoder"
    )
    vae = AutoencoderKL.from_pretrained(
                '/mnt/afs/user/wangxiaodong/driving-world-models/SDM/smodels/image-ep50-s192-1e-4', subfolder="vae"
    )
    clip_model = CLIPModel.from_pretrained(
        "/mnt/afs/user/wangxiaodong/driving-world-models/SDM/smodels/clip-vit-large-patch14", torch_dtype=torch.float16)
    ...
    tokenizer = CLIPTokenizer.from_pretrained('/mnt/afs/user/wangxiaodong/driving-world-models/SDM/smodels/image-ep50-s192-1e-4', subfolder="tokenizer")
    scheduler = DDIMScheduler.from_pretrained('/mnt/afs/user/wangxiaodong/driving-world-models/SDM/smodels/image-ep50-s192-1e-4', subfolder="scheduler")
    feature_extractor = CLIPImageProcessor.from_pretrained('/mnt/afs/user/wangxiaodong/driving-world-models/SDM/smodels/image-ep50-s192-1e-4', subfolder="feature_extractor")
...
def main(
    pretrained_model_name_or_path = '/mnt/afs/user/wangxiaodong/driving-world-models/SDM/smodels-vis/VA_Attn_sg-5e-5/checkpoint-2000',
    num_frames = 8,
    root_dir = '/mnt/afs/user/wangxiaodong/driving-world-models/SDM/FVD-first',
    train_frames = 8,
    device='cuda',
    roll_out= 1,
    cfg_min = 1.0,
    ...
    # caption model
    git_processor_large = AutoProcessor.from_pretrained("/mnt/afs/user/wangxiaodong/driving-world-models/SDM/smodels/git-large-coco")
    git_model_large = AutoModelForCausalLM.from_pretrained("/mnt/afs/user/wangxiaodong/driving-world-models/SDM/smodels/git-large-coco")
