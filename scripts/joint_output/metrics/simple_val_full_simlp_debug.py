...
from diffusers.models.unet_action_joint_simlp import UNetSpatioTemporalConditionModel_Action
...
def main(
    pretrained_model_name_or_path = '/mnt/afs/user/wangxiaodong/driving-world-models/SDM/smodels-vis/VA_SimMLP-5e-5/checkpoint-500',
    num_frames = 8,
