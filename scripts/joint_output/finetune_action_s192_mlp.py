...
from diffusers.models.unet_action_joint_mlp import UNetSpatioTemporalConditionModel_Action
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(unet):
                ...
                # NOTE action
                avg_loss_ac = accelerator.gather(loss.repeat(args.train_batch_size)).mean()
