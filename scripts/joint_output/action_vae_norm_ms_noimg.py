...
# from diffuser.models.unet_action_joint_attn import UNetSpatioTemporalConditionModel_Action
from diffuser.models.action_layers_norm import ActionCoarseModule
...
def main():
    ...
    # for action
    action_model = ActionCoarseModule(cross_attention_dim=None)
    action_model.train()
