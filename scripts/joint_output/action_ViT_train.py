...
def main():
    ...
    # for action
    from action_ViT_config import GlobalConfig
    config = GlobalConfig()
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(action_model):
                ...
                action_pred = action_model(history_action, image_context)
                        ...
                        for n, batch in tqdm(enumerate(val_dataloader)):
                            ...
                            with torch.no_grad():
                                ...
                                for _ in range(num_frames):
                                    action_pred = action_model(history_action_, image_context) # b, 1, d
