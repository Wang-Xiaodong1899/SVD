...
def main():
    ...
    with accelerator.main_process_first():
        train_dataset = Actionframes(split='train', args=args, tokenizer=tokenizer, img_size=(192, 384), history_len=args.history_len, max_video_len = 1)
        val_dataset = val_Actionframes(None, split='val', tokenizer=tokenizer, img_size=(192, 384), max_video_len = 8)
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(action_model):
                ...
                _, action_pred = action_model(history_action)
            ...
            if accelerator.sync_gradients:
                ...
                if global_step % args.eval_steps == 0:
                    if accelerator.is_main_process:
                        ...
                        gather_his = torch.cat(gather_his, dim=0) # tbsz, f, d
