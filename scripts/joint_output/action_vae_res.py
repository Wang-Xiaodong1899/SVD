...
from diffusers.models.action_layers import ActionCoarseModule
...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default="VAE_action_residual_s192",
        help=(
...
def main():
    ...
    # for action
    action_model = ActionCoarseModule(cross_attention_dim=640, decode_with_residual=True)
    action_model.train()
