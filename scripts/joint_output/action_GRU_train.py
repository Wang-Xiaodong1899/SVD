...
from diffuser.models.action_gru import Action_GRU
...
def main():
    ...
    # for action
    action_model = Action_GRU(2, 1024, cross_attention_dim=640)
    action_model.train()
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(action_model):
                ...
                _, action_pred = action_model(history_action, image_context, tgt_len=8)
