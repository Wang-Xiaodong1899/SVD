...
from .unet_3d_blocks_action_v04 import UNetMidBlockSpatioTemporal, get_down_block, get_up_block
...
class UNetSpatioTemporalConditionModel_Action(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    ...
    def __init__(
        ...
        self.action_embedding = TimestepEmbedding(addition_time_embed_dim*2, time_embed_dim, out_dim=768) # 2 because steer and speed numbers
