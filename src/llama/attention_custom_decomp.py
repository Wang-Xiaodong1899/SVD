...
class LlamaModeling(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.padding_idx = 0
        self.args = args
        self.embed_tokens_1 = nn.Linear(1, args.hidden_size, bias=False)
        self.embed_tokens_2 = nn.Linear(1, args.hidden_size, bias=False)
        ...
        self.lm_head_1 = nn.Linear(args.hidden_size, 1)
        self.lm_head_2 = nn.Sequential(
    ...
    def forward(self, input_ids=None, attention_mask=None, image_context=None, past_key_values=None, inputs_embeds=None, use_cache=False):
        ...
        if inputs_embeds is None:
            inputs_embeds_1 = self.embed_tokens_1(input_ids[:, :, 0:1])
            inputs_embeds_2 = self.embed_tokens_2(input_ids[:, :, 1:])

            inputs_embeds = inputs_embeds_1 + inputs_embeds_2
        ...
        logits_1 = self.lm_head_1(hidden_states)
        logits_2 = self.lm_head_2(hidden_states)
        logits = torch.cat([logits_1, logits_2], dim=-1) # b f 2
