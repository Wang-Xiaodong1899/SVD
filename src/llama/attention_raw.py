...
class LlamaModeling(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.args = args
        self.embed_tokens = nn.Embedding(args.vocab_size, args.hidden_size, self.padding_idx)  # bsz * seq_len
        self.layers = nn.ModuleList([LlamaDecoderLayer(args) for _ in range(args.n_layers)])
    ...
    def forward(self, input_ids=None, attention_mask=None, past_key_values=None, inputs_embeds=None, use_cache=False):
