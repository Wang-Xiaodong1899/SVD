...
class LlamaModeling(nn.Module):
    ...
    def forward(self, input_ids=None, attention_mask=None, image_context=None,
        ...
        hidden_states_ = lm_head_intermediate[0]

        return {"hidden_states": hidden_states_, "next_cache": next_cache, 'logits': logits, 'last_second_hidden_states': all_hidden_states[-2]}
