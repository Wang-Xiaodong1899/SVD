...
from .action_layers_norm import ActionCoarseModule
...
class UNetSpatioTemporalConditionModel_Action(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    ...
    def __init__(
        ...
        # action branch
        self.wm_action = ActionCoarseModule(cross_attention_dim=640)
    ...
    def forward(
        ...
        if skip_video:
            predict_action = self.wm_action.decoder(pred_action_embedding)
        else:
