...
from .resnet_action_base import (
    Downsample2D,
    ResnetBlock2D,
    SpatioTemporalResBlock,
    SpatioTemporalResBlockContext,
    SpatioTemporalResUpBlockContext,
    TemporalConvLayer,
    Upsample2D,
)
from .transformer_2d import Transformer2DModel
from .transformer_temporal_wm import (
    TransformerSpatioTemporalModel,
    TransformerTemporalModel,
)

# NOTE transformer_temporal_v01
# Use single text to cross attend the whole video
...
class UNetMidBlockSpatioTemporal(nn.Module):
    def __init__(
        ...
        num_attention_heads: int = 1,
        cross_attention_dim: int = 1280,
        temp_cross_attention_dim: int = 1280,
        eps: float = 1e-5,
        temp_style: str = "text"
    ):
        super().__init__()
